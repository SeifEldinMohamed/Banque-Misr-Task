...
import com.seif.banquemisrttask.data.repositoryImp.DefaultRepository
...
object DatabaseModule {
    ...
    ) = DefaultRepository(localDataSource, remoteDataSource) as com.seif.banquemisrttask.domain.repository.Repository
}
